...
so we just completed the process of read_xray_once.py and build_xray_dataset.py. And the dataset divided is necessary in the /dataset/xray/ .  
The links of them are below.  
